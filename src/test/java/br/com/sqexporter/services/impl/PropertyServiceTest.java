...
public class PropertyServiceTest {
	...
	private static final String WBMA_PROPERTIES_TEST = "sq.properties";

	@Before
	public void setUp() throws Exception {
		propertyService = new PropertyService();
		InputStream resourceAsStream = this.getClass().getClassLoader()
				.getResourceAsStream(WBMA_PROPERTIES_TEST);
	...
	public void testGetProp() {
		...
		Optional<String> clientSecret = propertyService
				.getProp("client_secret");
	...
	public void testSetPropEager() throws Exception {
		...
		FileOutputStream fileOutputStream = new FileOutputStream(this.getClass()
				.getClassLoader().getResource(WBMA_PROPERTIES_TEST).getFile());
		propertyService.getProp().store(fileOutputStream, "BIKE-IT");
